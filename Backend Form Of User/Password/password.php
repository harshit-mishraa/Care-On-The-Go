...
$new = $_POST['new'] ;
$query="SELECT password FROM customer.contact";
$result=mysqli_query($con,$query);
$rows=mysqli_fetch_array($result);

if($old==$rows[0] && $confirm==$new)
{
    $sql1 = "UPDATE customer.contact SET password ='$confirm' WHERE password='$old';";
    $sql2 = "UPDATE admin.customers SET password='$confirm' WHERE password='$old';";
