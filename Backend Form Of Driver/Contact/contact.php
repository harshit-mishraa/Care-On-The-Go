            ...
            <div class="profile">
                ...
                <form class="form" action="contact.php" method="POST">
                    ...
                    if(isset($_POST['mobile']))
                    {
                        ...
                        $query="UPDATE driver.contact SET name='$name',mobile='$mobile',email='$email',dob='$dob',city='$city',address='$address'; ";
                        $data=mysqli_query($conn,$query);
                        $query1="UPDATE admin.drivers SET name='$name',mobile='$mobile',email='$email'; ";
                        ...
                        if($data)
                        {
                            ...
                            <script>
                                ...
                                window.location.href = "http://localhost/Care%20On%20The%20Go(DevJam)(NEW)/Backend%20Form%20Of%20Driver/Contact/contact.php";
                            </script>
                            <?php
                    ...
                    {    $query="select * from driver.contact";
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="city" id="city" placeholder="City" value="<?php echo $rows['city'];?>">
                    </div>
                    <div class="form-group">
                        <label for="address">Address:</label>
                        <input type="text" name="address" id="address" placeholder="Address" value="<?php echo $rows['address'];?>">
                    </div>
                    <div>
